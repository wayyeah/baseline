...
for sensor in sensors:
    database_save_path = Path(data_path) / ('gt_database_%s2ouster_2modules' % (sensor) if split == 'train' else 'gt_database_%s_2modules' % ( split))
    db_info_save_path = Path(data_path) / ('gt_database_info_%s2ouster_2modules.pkl' % (sensor) if split == 'train' else 'pseudo_gt_database_info_%s_2modules.pkl' % (sensor, split))

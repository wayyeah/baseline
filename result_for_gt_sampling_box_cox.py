...
database_save_path = Path(data_path) / ('pseudo_gt_database_%s2%s_box_cox' % (source_sensor,target_sensor) if split == 'train' else 'gt_database_%s2%s_%s_box_cox' % (source_sensor,target_sensor, split))
db_info_save_path = Path(data_path) / ('pseudo_gt_database_info_%s2%s_box_cox.pkl' % (source_sensor,target_sensor) if split == 'train' else 'pseudo_gt_database_info_%s2%s_%s_box_cox.pkl' % (source_sensor,target_sensor, split))
